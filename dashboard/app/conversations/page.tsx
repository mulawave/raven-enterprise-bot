    ...
    <div className="flex flex-col" style={{ height: 'calc(100vh - 120px)' }}>
      ...
      <div className="flex items-center justify-between mb-3 shrink-0">
        ...
        <div className="flex items-center gap-3">
          {waInfo && (
            <div className={`flex items-center gap-1.5 rounded-lg px-3 py-1.5 text-xs font-medium ${waInfo.isConfigured ? 'bg-emerald-50 text-emerald-700 ring-1 ring-emerald-200' : 'bg-amber-50 text-amber-700 ring-1 ring-amber-200'}`}>
                ...
                <div className="flex items-center justify-between px-5 py-3 border-b border-gray-200 bg-white">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      ...
                      {selectedConversation.botOverride ? 'Bot paused' : 'Pause bot'}
                    </button>
                    ...
                    {selectedConversation.customerPhone && !contactForSelected && (
                      <button
                        ...
                        className="rounded-lg border border-gray-200 px-3 py-1.5 text-xs font-semibold text-gray-600 hover:bg-gray-50 flex items-center gap-1"
                      >
                        <svg className="h-3.5 w-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
