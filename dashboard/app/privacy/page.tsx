...
export const metadata = { title: 'Privacy Policy — Raven Business Automator (RBA)' }
    ...
    <div className="min-h-screen bg-[#0a0f1a] text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-16 prose prose-invert prose-slate">
        ...
        <section className="space-y-4 text-slate-300 text-sm leading-relaxed">
          ...
          <p>When you use Raven Business Automator (RBA), we collect information you provide directly — such as your business name, email address, and WhatsApp number — as well as technical data like IP addresses, browser type, and usage logs. Conversation data processed through the AI assistant is stored to improve response quality and provide analytics.</p>
          ...
          <p>Raven Business Automator (RBA) integrates with third-party services including WhatsApp Business API (Meta), OpenAI, Paystack, and your configured SMTP provider. Each provider has its own privacy policy governing data shared with them during normal operation.</p>
          ...
          <h2 className="text-lg font-semibold text-white">6a. Data Deletion Requests</h2>
          <p>
            If you interacted with a business powered by Raven Business Automator (RBA) (e.g., via WhatsApp), you can request
            permanent deletion of your conversation history, orders, and bookings by using the
            business's data deletion page. Ask the business for their deletion link, or submit a
            request directly at:{' '}
            <a href="/data-deletion" className="text-indigo-400 hover:underline">/data-deletion</a>.
            Requests are processed within 30 days. You will receive a confirmation code to track the
            status of your request.
          </p>

          <p>
            For deletion requests related to Facebook/Meta platform data, our callback handles these
            automatically via the Meta platform webhook. Your data is identified by your WhatsApp phone
            number and erased across all associated business accounts on this platform.
          </p>
